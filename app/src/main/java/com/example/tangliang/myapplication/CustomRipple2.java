 ...
 * 单个波纹
 */
public class CustomRipple2
{
    /** 波纹宿主控件 */
    private View host;
    /** 波纹宿主控件区域 */
    private Rect hostRect;//youhua:已经不需要
    /** 波纹半径 */
    private float radius;
    /** 波纹最大半径 */
    private float maxRaius;
    /** 波纹中心坐标 */
    ...
    /** 波纹类型 */
    private CustomRipple.Style style = themeManager.getRippleStyle();
    /** 波纹颜色 */
    ...
    public CustomRipple2(View host,
                         Point center,
                         float maxRadius)
    {
        this.host = host;
        this.center = center;
        this.maxRaius = maxRadius;
        initRipplePaint();
    }
...
//    }
    ...
    public void startFastRipple()
    {
        ...
        //2.开启快波纹
        radiusAnimator = ObjectAnimator.ofFloat(this, "radius", radius, maxRaius);
...
//        fastRippleAnimator.addListener(animatorListener); //youhua:加入多重波纹监听
...
//        }
    ...
    {
        radiusAnimator = ObjectAnimator.ofFloat(this, "radius", 0, maxRaius);
        radiusAnimator.setAutoCancel(true);
